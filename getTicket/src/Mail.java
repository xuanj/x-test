...
public class Mail { 
	...
	{ 
		try{ 
			...
			TicketMonitor.working = false;
			TicketMonitor.bt4.setSelected(true);
			...
			e.printStackTrace();
			if (e instanceof AuthenticationFailedException) JOptionPane.showMessageDialog(null,"邮件发送失败：请确认密码信息无误");//调用发送邮件接口
			return false; 
		} 
	} 
